...
ffmpeg -hide_banner -y \
  ...
  -filter_complex '
    ...
    [1:v]scale=1280:720:force_original_aspect_ratio=increase,crop=1280:720,eq=contrast=1.08:saturation=0.76:brightness=-0.04[base1];[base1][8:v]overlay=shortest=1,trim=duration=4,setpts=PTS-STARTPTS[v1];
    ...
    [5:v]scale=1280:720:force_original_aspect_ratio=increase,crop=1280:720,eq=contrast=1.08:saturation=0.74:brightness=-0.05[base5];[base5][12:v]overlay=shortest=1,trim=duration=8,setpts=PTS-STARTPTS[v5];
